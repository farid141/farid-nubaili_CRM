            ...
            <form id="create-product-form" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input id="create-name" type="text" placeholder="product Name" class="form-control"
                            name="name" required>
                    </div>
                    <div class="mb-3">
                        <label for="create-desc">Desc:</label>
                        <input id="create-desc" type="text" placeholder="product desc" class="form-control"
                            name="desc" required>
                    </div>
                    <div class="mb-3">
                        <label for="create-price">Price:</label>
                        <input id="create-price" type="number" placeholder="product price" class="form-control"
                            name="price" required>
                    </div>
                </div>
